...
describe 'Commands' do
  ...
  describe "Commands::CreateImage.create" do
    ...
    it "validates invalid CreateImage input with error" do
      expect{ Commands::CreateImage.create("A", 6) }.to raise_error("#{Error.not_valid_create_command}")
    end
  ...
  describe "Commands::ColourPixel.colour" do
    ...
    it "validates invalid ColourPixel input with error" do
      expect { Commands::ColourPixel.colour(image, "A", 5, "B") }.to raise_error("#{Error.not_valid_colour_command}")
    end
  ...
  describe "Commands::ColourVertical.colour_vertical" do
    ...
    it "validates invalid V sequence with error" do
      expect { Commands::ColourVertical.colour_vertical(image, 2, 3, 6, 40) }.to raise_error("#{Error.not_valid_vertical_command}")
    end
  ...
  describe "Commands::ColourHorizontal.colour_horizontal" do
    ...
    it "validates invalid H sequence with error" do
      expect { Commands::ColourHorizontal.colour_horizontal(image, 2, 3, 4, 40) }.to raise_error("#{Error.not_valid_horizontal_command}")
    end
